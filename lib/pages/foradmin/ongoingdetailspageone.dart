      ...
      child: Container(
        ...
        child: Stack(children: [
                ...
                if (snapshot.hasError) {
                  ...
                  if (snapshot.data == null) {
                    ...
                    return new Stack(
                      children: <Widget>[
                        Padding(
                          padding: isInvolve ? const EdgeInsets.only(left: 10, right: 10, top: 470.0, bottom: 20) : const EdgeInsets.only(left: 10, right: 10, top: 250.0, bottom: 20),
                          child: Container(
                            width: Get.width,
                            height: 600,
                            decoration: BoxDecoration(
          ...
          Stack(
            children: <Widget>[
              Padding(
                padding: const EdgeInsets.only(left: 10.0, right: 10.0, top: 1080, bottom: 30),
                child: Container(
                  width: Get.width,
                  height: 300,
                  decoration: BoxDecoration(
