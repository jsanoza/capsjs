...
class NewSched extends StatefulWidget {
  @override
  _NewSched createState() => _NewSched();
}

//TO DO save to DB who ever did the changes
class _NewSched extends State<NewSched> {
  @override
...
''',
  ...
  saveToDB() async {
    ...
    try {
      ...
      for (var i = 0; i < userSearchBlockName.length; i++) {
        QuerySnapshot search = await FirebaseFirestore.instance.collection('users').where('badgeNum', isEqualTo: userSearchBlockName[i]).get();
      ...
      for (var i = 0; i < userSearchItemsName.length; i++) {
        QuerySnapshot search = await FirebaseFirestore.instance.collection('users').where('badgeNum', isEqualTo: userSearchItemsName[i]).get();
        search.docs.forEach((document) {
          memuid.add(document.data()['collectionId']);
          FirebaseFirestore.instance
              .collection('users')
      ...
      for (var i = 0; i < userSearchArrestName.length; i++) {
        QuerySnapshot search = await FirebaseFirestore.instance.collection('users').where('badgeNum', isEqualTo: userSearchArrestName[i]).get();
        search.docs.forEach((document) {
          memuid.add(document.data()['collectionId']);
          FirebaseFirestore.instance
              .collection('users')
      ...
      for (var i = 0; i < userSearchSecurityName.length; i++) {
        QuerySnapshot search = await FirebaseFirestore.instance.collection('users').where('badgeNum', isEqualTo: userSearchSecurityName[i]).get();
        search.docs.forEach((document) {
          memuid.add(document.data()['collectionId']);
          FirebaseFirestore.instance
              .collection('users')
                                            ...
                                            onDismissed: (DismissDirection direction) {
                                              if (direction == DismissDirection.startToEnd) {
                                                ...
                                                mystate(() {
                                                  setState(
                                                    () {
                                                      userSearchBlockName.add(userPatrol[index]["badgeNum"]);
                                                      userSearchBlockx.add(userPatrol[index]["fullName"]);
                                                      userAll.add(userPatrol[index]["badgeNum"]);
                                                      userAll3.add(userPatrol[index]["badgeNum"]);
                                                      userAll4.add(userPatrol[index]["badgeNum"]);
                                                      userAll2.add(userPatrol[index]["badgeNum"]);
                                                    },
                                                  );
                                                });
                                              } else {
                                            ...
                                            onDismissed: (DismissDirection direction) {
                                              if (direction == DismissDirection.startToEnd) {
                                                ...
                                                mystate(() {
                                                  setState(
                                                    () {
                                                      userSearchSecurityName.add(userPatrol[index]["badgeNum"]);
                                                      userSearchSecurityx.add(userPatrol[index]["fullName"]);
                                            ...
                                            onDismissed: (DismissDirection direction) {
                                              if (direction == DismissDirection.startToEnd) {
                                                ...
                                                mystate(() {
                                                  setState(
                                                    () {
                                                      userSearchArrestName.add(userPatrol[index]["badgeNum"]);
                                                      userSearchArrestx.add(userPatrol[index]["fullName"]);
                                                      userAll.add(userPatrol[index]["badgeNum"]);
                                                      userAll3.add(userPatrol[index]["badgeNum"]);
                                                      userAll4.add(userPatrol[index]["badgeNum"]);
                                                      userAll2.add(userPatrol[index]["badgeNum"]);
                                                ...
                                                mystate(() {
                                                  setState(
                                                    () {
                                                      ...
                                                      userSearchItemsName.add(userPatrol[index]["badgeNum"]);
                                                      userSearchItemsx.add(userPatrol[index]["fullName"]);
                                                      userAll2.add(userPatrol[index]["badgeNum"]);
                                                      userAll3.add(userPatrol[index]["badgeNum"]);
                                                      userAll4.add(userPatrol[index]["badgeNum"]);
                                                      userAll.add(userPatrol[index]["badgeNum"]);
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              DropdownButton<String>(
                                                items: _stempty
                                                    ? _etempty
                                                        ? finalLeaderList.map((DocumentSnapshot document) {
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              DropdownButton<String>(
                                                items: _stempty
                                                    ? _etempty
                                                        ? finalSpotterList.map((DocumentSnapshot document) {
                                                            return new DropdownMenuItem<String>(
                                                              value: document["fullName"].toString(),
                                                              child: Text(document["fullName"].toString()),
                                                            );
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              DropdownButton<String>(
                                                items: _stempty
                                                    ? _etempty
                                                        ? finalSpokerspersonList.map((DocumentSnapshot document) {
                                                            return new DropdownMenuItem<String>(
                                                              value: document["fullName"].toString(),
                                                              child: Text(document["fullName"].toString()),
                                                            );
                                          ...
                                          return Dismissible(
                                            ...
                                            onDismissed: (DismissDirection direction) {
                                              if (direction == DismissDirection.startToEnd) {
                                                setState(
                                                  () {
                                                    userSearchItemsName.remove(userPatrol[index]["badgeNum"]);
                                                    userSearchItemsx.remove(userPatrol[index]["fullName"]);
                                                    userAll2.remove(userPatrol[index]["badgeNum"]);
                                                    userAll3.remove(userPatrol[index]["badgeNum"]);
                                                    userAll4.remove(userPatrol[index]["badgeNum"]);
                                                                ...
                                                                return Dismissible(
                                                                  ...
                                                                  onDismissed: (DismissDirection direction) {
                                                                    if (direction == DismissDirection.startToEnd) {
                                                                      setState(
                                                                        () {
                                                                          userSearchArrestName.remove(userPatrol[index]["badgeNum"]);
                                                                          userSearchArrestx.remove(userPatrol[index]["fullName"]);
                                                                          userAll2.remove(userPatrol[index]["badgeNum"]);
                                                                          userAll3.remove(userPatrol[index]["badgeNum"]);
                                                                          userAll4.remove(userPatrol[index]["badgeNum"]);
                                                                          userAll.remove(userPatrol[index]["badgeNum"]);
                                                                ...
                                                                return Dismissible(
                                                                  ...
                                                                  onDismissed: (DismissDirection direction) {
                                                                    if (direction == DismissDirection.startToEnd) {
                                                                      setState(
                                                                        () {
                                                                          userSearchSecurityName.remove(userPatrol[index]["badgeNum"]);
                                                                          userSearchSecurityx.remove(userPatrol[index]["fullName"]);
                                                                ...
                                                                return Dismissible(
                                                                  ...
                                                                  onDismissed: (DismissDirection direction) {
                                                                    if (direction == DismissDirection.startToEnd) {
                                                                      setState(
                                                                        () {
                                                                          userSearchBlockName.remove(userPatrol[index]["badgeNum"]);
                                                                          userSearchBlockx.remove(userPatrol[index]["fullName"]);
                                                                          userAll2.remove(userPatrol[index]["badgeNum"]);
                                                                          userAll3.remove(userPatrol[index]["badgeNum"]);
                                                                          userAll4.remove(userPatrol[index]["badgeNum"]);
                                                                          userAll.remove(userPatrol[index]["badgeNum"]);
