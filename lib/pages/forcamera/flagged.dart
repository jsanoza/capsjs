...
class Flagged extends StatefulWidget {
  final String vehicle, wherefrom;

  const Flagged({Key key, this.vehicle, this.wherefrom}) : super(key: key);
  ...
  showSomeone(BuildContext context) {
    ...
    Widget continueButton = FlatButton(
      ...
      onPressed: () {
        ...
        _btnController.reset();
        // Get.back();
          if (widget.wherefrom == 'user') {
            _btnController.reset();
            Get.offAll(UsersOngoingDetailsPage());
          } else {
            _btnController.reset();
...
''',
  ...
  saveFlag() async {
    ...
    if (_isTrue == true) {
      print(
          'show alert that there is already a flagged vehicle with this plate number!');
      showSomeone(context);
          ...
          FirebaseFirestore.instance
            ...
            FirebaseFirestore.instance
              ...
              FirebaseFirestore.instance
                ...
                'activity':
                    'Flagged a vehicle with plate number: ${widget.vehicle}',
  ...
  void initState() {
    ...
    _checked2 = [];
    print(widget.wherefrom + 'hahahahahahahaha');
    super.initState();
  }
                    ...
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Padding(
                            padding: const EdgeInsets.only(
                                top: 50.0, left: 10, right: 0, bottom: 0),
                            child: Row(
                              children: [
                                Text(
                                  "Other Reason/s:",
